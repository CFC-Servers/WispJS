...
const wisp_api_1 = require("./wisp_api");
const wisp_socket_1 = require("./wisp_socket");
class WispInterface {
    constructor(domain, uuid, token) {
        ...
        this.api = new wisp_api_1.WispAPI(domain, uuid, token, this.logger);
    }
    connect(ghPAT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.socket = new wisp_socket_1.WispSocket(this.logger, websocketInfo.url, websocketInfo.token, ghPAT);
